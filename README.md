# TACZ: Bow & Crossbow Guns 3D

> **Vanilla resource pack for Minecraft Bedrock Edition** that replaces vanilla ranged weapons with tactical 3D animated weapons and realistic sound effects, inspired by the Java mod **Timeless and Classics Zero (TaCZ)**.
...
### Method 2: Manual Folder
1. Download or clone this repository.
2. Place the folder into your Minecraft `resource_packs` directory:
   ...
   - **iOS**: Files app > `On My iPhone/iPad > Minecraft > games > com.mojang > resource_packs`
3. Launch Minecraft and activate the pack in Global Resources.
...
### License Terms:
1. **Audio & Visual Assets (3D Models, Textures, Sounds, and Keyframes)**:
   ...
   - **Non-Commercial (NC)**: This pack is 100% free and open-source. Commercial distribution, selling, paywalls (Patreon), or ad-monetized shorteners (AdFly, Linkvertise) are strictly prohibited.
   - **Attribution (BY)**: All original asset design rights belong to **The TaCZ Team**.
2. **Bedrock Configurations & Code (JSON schemas, render controllers, Molang expressions)**:
   - Licensed under the **[GNU General Public License v3.0 (GPL-3.0)](https://www.gnu.org/licenses/gpl-3.0.txt)**.
